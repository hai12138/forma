...
var (
	...
	ErrValidationFailed           = errors.New("forma capability validation failed")
	ErrPortsNotConfigured         = errors.New("forma capability validation ports not configured")
	ErrBusinessModelNotFound      = errors.New("forma capability business model not found")
	ErrContractNotFound           = errors.New("forma capability contract not found")
	ErrContractNotActive          = errors.New("forma capability contract not active")
)
