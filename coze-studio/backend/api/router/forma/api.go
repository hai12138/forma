...
func Register(r *server.Hertz) {
	...
	v1 := root.Group("/forma/v1", middleware.FormaTenantMW())
	{
		...
		v1.GET("/businesses/:id/capabilities", formahandler.ListCapabilities)
		v1.POST("/businesses/:id/capabilities", formahandler.CreateCapability)
		v1.POST("/businesses/:id/capabilities/analyze", formahandler.StartCapabilityAnalysis)
		v1.GET("/businesses/:id/capabilities/:capabilityId", formahandler.GetCapability)
		v1.GET("/businesses/:id/capabilities/:capabilityId/revisions", formahandler.ListCapabilityRevisions)
		v1.GET("/businesses/:id/capabilities/:capabilityId/revisions/:revisionId", formahandler.GetCapabilityRevision)
		v1.POST("/businesses/:id/capabilities/:capabilityId/derive", formahandler.DeriveCapability)
		v1.POST("/businesses/:id/capabilities/:capabilityId/edit", formahandler.EditCapability)
		v1.GET("/businesses/:id/capabilities/:capabilityId/decisions", formahandler.ListCapabilityDecisions)
		v1.GET("/businesses/:id/capability-analyses/:analysisRunId", formahandler.GetCapabilityAnalysis)
		v1.GET("/businesses/:id/capability-analyses/:analysisRunId/proposals", formahandler.ListCapabilityProposalsByAnalysis)
		v1.POST("/businesses/:id/capability-analyses/:analysisRunId/retry", formahandler.RetryCapabilityAnalysis)
		v1.GET("/businesses/:id/capability-proposals/:proposalId", formahandler.GetCapabilityProposal)
		v1.POST("/businesses/:id/capability-proposals/:proposalId/confirm", formahandler.ConfirmCapabilityProposal)
		v1.POST("/businesses/:id/capability-proposals/:proposalId/edit-confirm", formahandler.EditConfirmCapabilityProposal)
		v1.POST("/businesses/:id/capability-proposals/:proposalId/reject", formahandler.RejectCapabilityProposal)
		v1.POST("/businesses/:id/capability-revisions/:revisionId/validate", formahandler.ValidateCapabilityRevision)
		v1.POST("/businesses/:id/capability-revisions/:revisionId/activate", formahandler.ActivateCapabilityRevision)
		v1.POST("/businesses/:id/capability-revisions/:revisionId/deprecate", formahandler.DeprecateCapabilityRevision)
		v1.GET("/businesses/:id/capability-revisions/:revisionId/validations", formahandler.ListCapabilityValidations)
